...
export const mockDisputes: DisputeRecord[] = [
  {
    ...
    appeals: [],
    escrow: {
      requiredStakeWei: "2000000000000000000",
      claimantStakeWei: "2000000000000000000",
      respondentStakeWei: "2000000000000000000",
      claimantDeposited: true,
      respondentDeposited: true,
      totalEscrowWei: "4000000000000000000",
      winner: "",
      loserPenaltyBps: 0,
      operatorFeeBps: 0,
      winnerPayoutWei: "0",
  ...
  },
  {
    ...
    escrow: {
      requiredStakeWei: "1500000000000000000",
      claimantStakeWei: "1500000000000000000",
      respondentStakeWei: "1500000000000000000",
      claimantDeposited: true,
      respondentDeposited: true,
      totalEscrowWei: "3000000000000000000",
      winner: "CLAIMANT",
      loserPenaltyBps: 7000,
      operatorFeeBps: 500,
      winnerPayoutWei: "2475000000000000000",
      loserRefundWei: "375000000000000000",
      operatorFeeWei: "150000000000000000",
      settled: true,
    },
  },
];
